 <template>
  <div class="container col-md-6 offset-md-3 mt-5 text-warning">
    ...
    <!-- <div class="card shadow" style=" background-color: #0c192c;
    ...
    color: rgb(255, 255, 255);"> 
      ...
      <div class="card-body pl-5 pr-5">
        <div class="form-group mb-3">
          ...
          <input type="email" class="form-control text-white" v-model="email" placeholder="Email" />
        </div>
        <div class="form-group mb-3">
          <label for="password">Password:</label>
          <input type="password" class="form-control text-white" v-model="password" placeholder="Password" />
        </div>
        <div class="a-flex">
